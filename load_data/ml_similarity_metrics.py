...
def main():
    ...
    df_with_similarity_metrics = pd.read_pickle('similarity_mertics_df_2022-05-04.134203.pkl') #'similarity_mertics_df_2022-05-03.161109.pkl') # load saved df with features
